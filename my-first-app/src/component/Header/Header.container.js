...
const mapStateToProps = (state) => ({
    isMobileMenuOpen: state.NavigationReducer[NavigationType.TOP_NAVIGATION_TYPE].navigationState.name === 'menu'
});

/** @namespace Component/Header/Container/mapDispatchToProps */
const mapDispatchToProps = (dispatch) => ({
    toggleMobileMenu: () => dispatch(changeNavigationState(
        NavigationType.TOP_NAVIGATION_TYPE,
        { name: 'menu', force: true }
    ))
});
